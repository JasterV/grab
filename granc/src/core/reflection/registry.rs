...
//!
//! Its primary job is to take a string like `"my.package.Service/Method"` and return a
//! `MethodDescriptor` that contains all the type information needed for the Codec.
